...
public class GUnit {
    ...
    public static void main(String[] args) {
        ...
        while (!line.equals("It's testing time!")) {
            ...
            if (matcher.find()) {
                ...
                if (classes.containsKey(className)) {
                    ...
                    Map<String, List<String>> currentMethods = classes.get(className);
                    ...
                    if (currentMethods.containsKey(methodName)) {
                        ...
                        if (!currentUnitTests.contains(unitTest)) {
                            currentUnitTests.add(unitTest);
                        }
                    } else {
                    ...
                    classes.put(className, newMethods);
                }
            }
        ...
        for (Map.Entry<String, Map<String, List<String>>> entryClass : sortedClasses.entrySet()) {
            ...
            Map<String, List<String>> sortedMethods = entryClass
